...
export function CreateTaskModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal Content */}
      <div
        className="relative z-10 w-full max-w-4xl mx-4 max-h-[90vh] bg-card border border-border rounded-lg shadow-lg animate-in fade-in-0 zoom-in-95 flex flex-col"
